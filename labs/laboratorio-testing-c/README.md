...
> R:inicializa carro y si quiero guardar y no tengo el carro, no se va a guardar, por lo cual voy a tener perdida dc datos.
...
> R:falla, devuelve [carrito lleno: rechaza el quinto producto][FAIL] resultado => esperado 0, obtenido 1  (linea 65)*** stack smashing detected **: terminated Aborted (core dumped)
